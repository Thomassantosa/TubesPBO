...
public class UserTrainPanel extends JPanel implements ActionListener {
    ...
    public UserTrainPanel() {
        ...
        ArrayList<String> cityList = queryController.selectStationCity();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (departureDate.equals(null)) {
            ...
            MainFrame.setSearchTrain(departureCity, destinationCity, departureDate, seatClass);
            MainFrame.cardLayout.show(MainFrame.cardPanelUser, "searchTrainPanel");
        }
    }
}
